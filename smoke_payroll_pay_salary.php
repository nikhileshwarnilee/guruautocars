...
try {
    $structureStmt = $pdo->prepare(
        'INSERT INTO payroll_salary_structures
         ...
         VALUES
          (:user_id, :company_id, :garage_id, "MONTHLY", 14000, 0, NULL, "ACTIVE", :created_by)
    ...
    if ($itemId <= 0) {
        $insertItem = $pdo->prepare(
            'INSERT INTO payroll_salary_items
             ...
             VALUES
              (:sheet_id, :user_id, "MONTHLY", 14000, 14000, 0, 0, 0, NULL, 0, 0, 0, 0, 14000, 14000, 0, 0, "PENDING")'
        );
        $insertItem->execute([
            'sheet_id' => $sheetId,
            'user_id' => $staffId,
        ...
        $updateItem = $pdo->prepare(
            'UPDATE payroll_salary_items
             SET base_amount = 14000,
                 commission_base = 14000,
                 commission_rate = 0,
                 commission_amount = 0,
                 overtime_hours = 0,
                 overtime_rate = NULL,
